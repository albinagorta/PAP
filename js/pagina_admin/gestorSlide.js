...
$(".agregarSlide").click(function(){
	...
	var imgFondo = "default/fondo.jpg";
	...
	datos.append("pro", "slide");
	datos.append("op", "agregar");
			...
			$.ajax({
				...
				success: function(respuesta){					
					if(respuesta == 1){
						swal({
						  type: "success",
						  title: "El slide ha sido eliminado correctamente",
						  showConfirmButton: true,
						  confirmButtonText: "Cerrar"
						  }).then((result) => {
							if (result.value){

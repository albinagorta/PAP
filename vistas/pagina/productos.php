				...
				<div class="btn-group">
					 ...
					 <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
					  ...
					  <?php
						...
						echo '<li><a href="'.URL_DOMINIO.$url[0].'/1/recientes">Más reciente</a></li>
							  <li><a href="'.URL_DOMINIO.$url[0].'/1/antiguos">Más antiguo</a></li>';
	...
	<div class="container">
		...
		<div class="row">
			...
			<ul class="breadcrumb fondoBreadcrumb text-uppercase">
				...
				<li class="active pagActiva"><?php echo $url[0] ?></li>
			...
			if($url[0] == "articulos-gratis"){

				$item2 = "precio";
				$valor2 = 0;
				$ordenar = "id";

			}else if($url[0] == "lo-mas-vendido"){

				$item2 = null;
				$valor2 = null;
				$ordenar = "ventas";

			}else if($url[0] == "lo-mas-visto"){
...
$productos = Web::consultas('productos','AND $item2 =$valor2 ORDER BY $ordenar $modo LIMIT $base, $tope');

$listaProductos = Web::consultas('productos','AND $item2 = $valor2 ORDER BY $ordenar DESC'); 
}else{
	$productos = Web::consultas('productos','AND $item2 =$valor2 ORDER BY $ordenar $modo LIMIT $base, $tope');
	$listaProductos = Web::consultas('productos','AND $item2 = $valor2 ORDER BY $ordenar DESC');
}

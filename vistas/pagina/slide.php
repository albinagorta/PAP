	...
	<div class="row">
		...
		<ul>
			...
			<li>
				...
				<img src="<?php IMG; ?>slide/default/back_default.jpg">

				<div class="slideOpciones slideOpcion1">
					
					<img class="imgProducto" src="<?php echo IMG; ?>slide/default/articulo373.jpg" style="top:15%; right:10%; width:45%">
			...
			<li>
				...
				<img src="<?php echo IMG; ?>slide/default/back_default.jpg">

				<div class="slideOpciones slideOpcion2">
					
					<img class="imgProducto" src="<?php echo IMG; ?>slide/default/articulo373.jpg" style="top:5%; left:15%; width:25%">
			...
			<li>
				...
				<img src="<?php echo IMG; ?>slide/default/fondo2.jpg">
			...
			<li>
				...
				<img src="<?php echo IMG; ?>slide/default/fondo3.jpg">

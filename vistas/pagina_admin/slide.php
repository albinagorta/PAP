<?php
 ...
 $slide = Web::consultas('slide','ORDER BY orden ASC');
...
foreach ($slide as $key => $value) {  
  ...
  $estiloImgProducto = json_mostrar($value["estiloImgProducto"]);
  $estiloTextoSlide = json_mostrar($value["estiloTextoSlide"]);
  $titulo1 = json_mostrar($value["titulo1"]);
  $titulo2 = json_mostrar($value["titulo2"]);
  $titulo3 = json_mostrar($value["titulo3"]);
            ...
            <div class="panel box box-info">
              ...
              <div id="collapse'.$value["id"].'" class="panel-collapse collapse collapseSlide">
                  ...
                  <div class="col-md-4 col-xs-12">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <p class="help-block">
                        <img src="'.IMG."slide/".$value["imgFondo"].'" class="img-thumbnail previsualizarFondo" width="200px">
                        </p>
                  ...
                  <div class="col-md-4 col-xs-12">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <p class="help-block">
                          <img src="'.IMG."slide/".$value["imgProducto"].'" class="img-thumbnail previsualizarProducto" width="200px">
                        </p>
                ...
                <div class="slide">
                  ...
                  <img class="cambiarFondo" src="'.IMG."slide/".$value["imgFondo"].'">

                  <div class="slideOpciones '.$value["tipoSlide"].'">

                    <img class="imgProducto" src="'.IMG."slide/".$value["imgProducto"].'" style="top:'.$estiloImgProducto["top"].'%; right:'.$estiloImgProducto["right"].'%; width:'.$estiloImgProducto["width"].'%; left:'.$estiloImgProducto["left"].'%">        

      ...
      <div class="box-body">
        ...
        <table class="table table-bordered table-striped dt-responsive tablaPerfiles" width="100%">
          ...
          <tbody>
            ...
            $perfiles = Web::consultas('administradores');
             ...
             foreach ($perfiles as $key => $value){
                 ...
                 echo ' <tr>
                         ...
                         if($value["foto"] != ""){
                          ...
                          echo '<td><img src="'.IMG.'perfiles/'.$value["foto"].'" class="img-thumbnail" width="40px"></td>';

                         }else{

                            echo '<td><img src="http://localhost/backend/vistas/img/perfiles/default/anonymous.png" class="img-thumbnail" width="40px"></td>';
    ...
    <div class="modal-content">
      ...
      <form id="formagregar"  method="post" enctype="multipart/form-data">
          ...
          <div class="box-body">
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <p class="help-block">Peso máximo de la foto 2MB | tamaño 500 x 500</p>

              <img src="<?php echo IMG; ?>perfiles/default/anonymous.png" class="img-thumbnail previsualizar" width="100px">
        ...
        <div class='modal-footer'>
          ...
          <input type='hidden'  name='pro' value='administradores'>
    ...
    <div class="modal-content">
      ...
      <form id='formeditar' method="post" enctype="multipart/form-data">
          ...
          <div class="box-body">
            ...
            <!-- ENTRADA PARA EL EMAIL -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="email" class="form-control input-lg" id="editarEmail" name="email" value="" required>
            ...
            <!-- ENTRADA PARA LA CONTRASEÑA -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="hidden" id="passwordActual" name="passwordantigua">
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <input type="hidden" name="fotoantigua" id="fotoActual">
        ...
        <div class="modal-footer">
          ...
          <input type='submit' class='btn btn-primary' value='Modificar Perfil'>
          <img src='<?php echo IMG; ?>load.gif' class='load'>

	...
	<div class="box-body">
		...
		<div class="form-group">
			...
			<p class="pull-right">
				...
				<img src="<?php  echo IMG.$plantilla["logo"]; ?>" class="img-thumbnail previsualizarLogo" width="200px">
	...
	<div class="box-body">
		...
		<div class="form-group">
			...
			<p class="pull-right">
				...
				<img src="<?php  echo IMG.$plantilla["icono"]; ?>" class="img-thumbnail previsualizarIcono" width="50px">

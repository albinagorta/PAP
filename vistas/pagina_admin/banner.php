    ...
    <div class="modal-content">
      ...
      <form  id='formeditar' method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="hidden" class="idBanner" name="id">
              
              <div class="panel">CAMBIAR IMAGEN DE BANNER</div>

               <input type="file" class="fotoBanner" name="foto">
               <input type="hidden" class="antiguaFotoBanner" name="fotoantigua">

               <p class="help-block">Tamaño recomendado 550px * 1600px <br> Peso máximo de la foto 2MB</p>

                <img src="<?php echo IMG; ?>banner/default/default.jpg" class="img-thumbnail previsualizarBanner" width="100%">
        ...
        <div class="modal-footer">
          ...
          <input type="submit" class="btn btn-primary" value="Guardar cambios banner">
          <input type="hidden" name='pro' value="banner">

...
$productos = Web::consultas('productos','ORDER BY fecha DESC');
...
<div class="box box-primary">
   ...
   <!-- box-header -->
	    	...
	    	for($i = 0; $i < 5; $i++){
	    		...
	    		echo '<li class="item">
				        <div class="product-img">
				          <img src="'.IMG.'productos/'.$productos[$i]["portada"].'" alt="Product Image" style="width:100px;margin-right:10px;">
				        </div>
  	...
  	<div class="box-footer text-center">
    	...
    	<a href="<?php echo URL_DOMINIO_ADMIN; ?>productos" class="uppercase">Ver todos los productos</a>
